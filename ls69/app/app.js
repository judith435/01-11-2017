...
app.controller('booksCtrl', function booksCtrl($scope, cartService, $http) {
    $http({
        method : "GET",
        url : "data.json"
    }).then(success, error);
...
app.controller('buyCtrl', function showCartCtrl($scope,$routeParams, cartService, orderService) {
